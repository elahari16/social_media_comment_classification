...
const createComment = async (req, res) => {
  try {
    ...
    const { content, parentId, userId, is_toxic, classification } = req.body;
    ...
    // Create comment with classification data
    const comment = await Comment.create({
      content,
      parent: parentId,
      post: postId,
      commenter: userId,
      is_toxic: is_toxic || false,
      classification: classification || "non-toxic"
    });
